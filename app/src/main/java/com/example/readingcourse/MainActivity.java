    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!hasUsageStatsPermission(this)) {
            ...
            builder.setTitle("Permissions Needed")
                    .setMessage("ReadingCourse requires extra permissions to view your app usage data. Grant these permissions on the next screen.")
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setTitle("Permissions Needed")
                    .setMessage("ReadingCourse requires extra permissions to show an app usage HUD on your screen. Grant these permissions on the next screen.")
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            dialog.dismiss();
